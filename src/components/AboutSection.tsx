            ...
            <div className="order-2 lg:order-1">
              <div className="relative">
                ...
                <img 
                  src={drJohnnyImage} 
                  alt="Dr. Johnny Secco" 
                  className="relative w-full max-w-md mx-auto object-cover rounded-lg shadow-form"
                />
              </div>
            </div>
            ...
            <div className="order-1 lg:order-2 space-y-8">
              ...
              <div className="grid grid-cols-2 gap-4">
                {achievements.map((achievement, index) => (
                  <Card key={index} className="border-border hover:shadow-medical transition-all duration-300">
